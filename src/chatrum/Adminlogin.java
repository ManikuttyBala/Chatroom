...
if((username.getText().equals(""))||(Password.getText().equals("")))
        {
         ...
         DataBaseConnection objDB=new DataBaseConnection();
                   String qry="select count(Pass) as cnt  from adminlogintb where BINARY AdminName='"+username.getText()+"' and BINARY Pass='"+Password.getText()+"' ";
